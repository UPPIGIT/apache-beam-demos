...
args = {
	'owner': 'airflow',
	'start_date': datetime(2021,6,27), #you can change this start_date
	'retries': 1,
...
task1 = BashOperator(task_id='create_directory', bash_command='mkdir ~/gcs/data/test_dir', dag=dag)


#task2 is to get the 'shasum' of 'test_dir' directory
task2 = BashOperator(task_id='get_shasum', bash_command='shasum ~/gcs/data/test_dir', dag=dag)
